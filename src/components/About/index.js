...
import {AboutSection,AboutInfo,InfoTitle,InfoDir,Span,InfoDesc,Anchor} from  './style.js';
        ...
        <AboutSection>
            <div class="container">
                <AboutInfo>
                    ...
                    <InfoDesc>
                        Lorem ipsum dolor sit amet, consectetur adipisicing      nisi cupiditate ad veritatis?
                    </InfoDesc>
                </AboutInfo>
            </div>
        </AboutSection>
